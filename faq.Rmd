...
<div id="faq8" style="display:none">`powRICLPM` is an R-package that performs a power analysis for the RI-CLPM in a simple and user-friendly way. It implements the strategy as proposed by Mulder (in press). `powRICLPM` is available from the Comprehensive R Archive Network (CRAN). More information can be found at [https://jeroendmulder.github.io/powRICLPM/](https://jeroendmulder.github.io/powRICLPM/).</div>
