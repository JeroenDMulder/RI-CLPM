...
Lately, we have received numerous questions about statements regarding the use and appropriateness of the CLPM and RI-CLPM in "Testing Prospective Effects in Longitudinal Research: Comparing Seven Competing Cross-Lagged Models" by [Orth et al. (2021)](http://dx.doi.org/10.1037/pspp0000358). In our opinion, numerous conclusions herein are unwarranted. Below we elaborate on what we consider some of their most prominent conclusions. 
