...
MODEL CONSTRAINT:
  ...
  ! Contrain residual variances of within-components such that
  ! variance of each within-component equals 1
...
### Extra
    ...
    MODEL:      !!!!!!!!!!!!!!!!    
                ...
                ! Create single random intercept for all X-variables, and another
                ! for all Y-variables. Constrain factor loading to be identical to 
                ! within-person factor loadings.
...
We have to overrule the default of Mplus to include a term for measurement error when the `BY` statement is used, through `FX1@0 FX2@0 ...;`. The two random intercepts are allowed to be freely correlated with each other, through `RIX WITH RIY;`.
    ...
    MODEL:      !!!!!!!!!!!!!!!!!!!!!
                ...
                ! Specify lagged effects between within-person centered 
                ! latent variables. 
                WFX2 WFY2 ON WFX1 WFY1;
                WFX3 WFY3 ON WFX2 WFY2;
                WFX4 WFY4 ON WFX3 WFY3;
